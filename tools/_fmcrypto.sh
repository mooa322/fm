...
FM_PAYLOAD=(menu.sh ssh update_panel.sh panel/panel.py panel/index.html panel/reseller.html panel/v2ray_manager.py panel/bandwidth_link.py panel/connlog.py)
