...
descargar() {
    ...
    echo -ne "�404 Intentando descargar desde: $servidor"
    ...
    if wget -q --no-check-certificate -t3 -T3 -O "$front_file_local" "$url"; then
        ...
        echo -e "�40017 /n $servidor Fallo. Reintentando con otro...\n"
...
# Si la respuesta es 'si', ejecutamos la funci�n
